...
.method public addNfcUnlockHandler(Landroid/nfc/INfcUnlockHandler;[I)V
    ...
    invoke-static {v1}, Lcom/android/nfc/NfcService;->access$1700(Lcom/android/nfc/NfcService;)Lcom/android/nfc/NfcUnlockManager;
...
.method public disable(Z)Z
    ...
    iput-boolean v3, v0, Lcom/android/nfc/NfcService;->mNfcOnWhileAirplaneModeOn:Z
...
.method public enable()Z
    ...
    iput-boolean v1, v2, Lcom/android/nfc/NfcService;->mNfcOnWhileAirplaneModeOn:Z
...
.method public getSelectedCardEmulation()I
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public getSupportCardEmulation()I
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public invokeBeam()V
    ...
    invoke-static {v0}, Lcom/android/nfc/NfcService;->access$1500(Lcom/android/nfc/NfcService;)Lcom/android/nfc/ForegroundUtils;
...
.method public is2ndLevelMenuOn()Z
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public pausePolling(I)V
    ...
    invoke-interface {v2}, Lcom/android/nfc/DeviceHost;->disableDiscovery()Z

    move-result v2

    # setter for: Lcom/android/nfc/NfcService;->mDiscoveryEnabled:Z
    invoke-static {v0, v2}, Lcom/android/nfc/NfcService;->access$702(Lcom/android/nfc/NfcService;Z)Z
...
.method public removeNfcUnlockHandler(Landroid/nfc/INfcUnlockHandler;)V
    ...
    # getter for: Lcom/android/nfc/NfcService;->mNfcUnlockManager:Lcom/android/nfc/NfcUnlockManager;
    invoke-static {v0}, Lcom/android/nfc/NfcService;->access$1700(Lcom/android/nfc/NfcService;)Lcom/android/nfc/NfcUnlockManager;
...
.method public selectCardEmulation(I)V
    .locals 1
...
.method public set2ndLevelMenu(Z)V
    .locals 1
    .param p1, "onOff"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public setAppCallback(Landroid/nfc/IAppCallback;)V
    ...
    invoke-static {v1}, Lcom/android/nfc/NfcService;->access$1400(Lcom/android/nfc/NfcService;)Landroid/os/UserManager;
...
.method public setReaderMode(Landroid/os/IBinder;Landroid/nfc/IAppCallback;ILandroid/os/Bundle;)V
    ...
    invoke-static {v1}, Lcom/android/nfc/NfcService;->access$1600(Lcom/android/nfc/NfcService;)Lcom/android/nfc/NfcService$ReaderModeDeathRecipient;
